...
const NAV = [
  ...
  { to: '/scalping', label: 'Scalping', icon: '⚡' },
  ...
  return (
    <aside className="w-64 shrink-0 border-r border-slate-800 bg-slate-950 flex flex-col">
      <div className="p-5 border-b border-slate-800">
        <p className="text-emerald-400 text-xs uppercase tracking-widest">Phase 5</p>
        <h1 className="text-lg font-bold mt-1">Command Center</h1>
        <p className="text-slate-500 text-xs mt-1 truncate">{user?.username} · {user?.role}</p>
      </div>
