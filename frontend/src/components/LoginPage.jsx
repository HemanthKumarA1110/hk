    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex items-center justify-center p-6">
      <div className="w-full max-w-5xl grid lg:grid-cols-2 gap-8">
        <section className="rounded-2xl border border-slate-800 bg-gradient-to-br from-slate-900 to-slate-950 p-8 shadow-2xl">
          <p className="text-emerald-400 text-sm font-semibold tracking-widest uppercase">Trading Platform</p>
          <h1 className="mt-3 text-4xl font-bold">Indian AI Trading Platform</h1>
          <p className="mt-4 text-slate-400 leading-relaxed">
            Sign in, then connect Angel One for live trading — or skip broker setup and use paper trading from
            the Live Trading page.
          </p>
