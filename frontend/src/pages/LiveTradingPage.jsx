...
import { fetchOrderStatus, fetchOrders } from '../api'
    ...
    <div>
      <header className="mb-6">
        ...
        <p className="text-slate-400 mt-1 max-w-3xl">
          One place for manual Angel One orders, AI auto bots (scalping, intraday, swing), and activity.
          Connect Angel One before placing orders.
        </p>
      </header>
      ...
      {pageTab === 'activity' && (
        <>
          ...
          <div className="grid gap-4 lg:grid-cols-2 mb-6">
            <BrokerTradeFeedContainer />
            <section className="rounded-xl border border-slate-800 bg-slate-900/60 p-4">
              <h3 className="font-semibold mb-3">Recent Orders (Platform)</h3>
